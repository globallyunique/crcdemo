...
class UserPasswordFormTest extends BrowserTestBase {
  ...
  public function dataCore() {
    $data = [];
    $use_new_messages = version_compare(\Drupal::VERSION, '9.2.0', '>');
    ...
    $data['only-coupled'] = [
      ...
      'email' => 'test@example.com',
      'expected_message' => $use_new_messages ? 'Status message If test@example.com is a valid account, an email will be sent with instructions to reset your password.' : 'Status message Further instructions have been sent to your email address.',
      'expected_user_key' => 0,
    ];
